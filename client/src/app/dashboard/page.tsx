        ...
        >
          <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-gray-900 dark:text-gray-100">{tasks?.length || 0}</span>
          ...
          <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wide">
             ...
             <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-blue-600">{tasks?.filter((t) => t.status === "IN_PROGRESS").length || 0}</span>
                <span className="text-sm text-blue-500 font-medium">Active</span>
            </div>
          </div>
          <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wide">Completed</div>
             <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-green-600">{tasks?.filter((t) => t.status === "COMPLETED").length || 0}</span>
                <span className="text-sm text-green-500 font-medium">Finished</span>
            </div>
          </div>
        </motion.div>
          ...
          >
            <div className="text-center max-w-md p-6">
              ...
              <p className="text-muted-foreground text-lg mb-8">
                Start organizing your work by creating your first task. Track
